    ...
    <div class="card-body p-0">
      <div class="d-flex justify-content-between align-items-center px-4 py-3"
        ...
        <div>
          ...
          <p class="text-muted mb-0" style="font-size:12px;">Manage product categories</p>
        </div>
        ...
        <table class="table table-hover align-middle mb-0" style="font-size:13px;">
          <thead style="background:#f9f9f9;">
            <tr>
              ...
              <th class="py-3 border-0 text-muted fw-semibold" style="font-size:11px;letter-spacing:1px;text-transform:uppercase;">Name</th>
          ...
          <tbody>
            @foreach ($categories as $category)
              <tr style="border-bottom:1px solid #f7f7f7;">
                <td class="px-4 border-0 text-muted">{{ $category->id }}</td>
                <td class="border-0">
                  @if ($category->image)
                ...
                <td class="border-0 fw-semibold">{{ $category->name }}</td>
